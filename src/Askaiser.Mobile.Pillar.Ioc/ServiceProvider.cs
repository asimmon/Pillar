...
using Askaiser.Mobile.Pillar.Ioc.Internal;
using Askaiser.Mobile.Pillar.Ioc.ServiceLookup;
...
namespace Askaiser.Mobile.Pillar.Ioc
{
    ...
    internal class ServiceProvider : IServiceProvider, IDisposable
    {
        ...
        private static readonly MethodInfo TryGetValueMethodInfo = GetMethodInfo<Func<IDictionary<IService, object>, IService, object, bool>>((a, b, c) => a.TryGetValue(b, out c));
        private static readonly MethodInfo AddMethodInfo = GetMethodInfo<Action<IDictionary<IService, object>, IService, object>>((a, b, c) => a.Add(b, c));
