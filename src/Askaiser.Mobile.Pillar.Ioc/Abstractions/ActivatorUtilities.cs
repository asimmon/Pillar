...
namespace Askaiser.Mobile.Pillar.Ioc.Abstractions
{
    ...
    public static class ActivatorUtilities
    {
        ...
        {
            return InternalActivatorUtilities.CreateInstance(provider, instanceType, parameters);
        }
        ...
        {
            return InternalActivatorUtilities.CreateFactory(instanceType, argumentTypes);
        }
        ...
        {
            return InternalActivatorUtilities.CreateInstance<T>(provider, parameters);
        }
